...
public abstract class Client {
	...
	{
		//Using a ConcurrentLinkedQueue for messages allows us to provide thread safety
		//over having our sending thread writing into a ByteBuffer designed to be read by the network thread
		msgQueue.add(msg);
	}
